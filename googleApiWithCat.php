...
$con=mysqli_connect("localhost","root","","smart_city_db");
 ...
 $query1="select * from location_master where cat_id=".$cat_id;
...
$xml = new XMLReader(); 
//echo "https://maps.googleapis.com/maps/api/directions/xml?origin=".$origin_geo."&destination=".$desti_geo."&key=AIzaSyCJbHo0H0o5LHs92pDkRl46U_VyoliyNr0";
